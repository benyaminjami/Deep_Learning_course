...
def normal_initializer(shape, name=None):
    ...
    #####################################################
    return tf.Variable(initial_value=tf.truncated_normal(shape=shape, mean=0.0, stddev=0.01), name=name)
    #####################################################
    #                 END OF YOUR CODE                  #
    #####################################################
...
def zero_initializer(shape, name=None):
    ...
    # Return the defined tf.Variable          #
    ###########################################
    return tf.Variable(initial_value=tf.zeros(shape=shape), name=name)
    ###########################################
    #           END OF YOUR CODE              #
    ###########################################
